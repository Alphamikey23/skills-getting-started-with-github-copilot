...
activities = {
    ...
    "Soccer Team": {
        ...
        "max_participants": 18,
        "participants": ["alex@mergington.edu", "rachael@mergington.edu"]
    },
    "Basketball Club": {
    ...
    "Art Club": {
        ...
        "max_participants": 20,
        "participants": ["leah@mergington.edu", "oscar@mergington.edu"]
    },
    "Drama Club": {
        "description": "Theater rehearsals and seasonal productions",
        "schedule": "Mondays and Thursdays, 4:00 PM - 6:30 PM",
        "max_participants": 25,
